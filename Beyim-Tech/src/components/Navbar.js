...
import logo from "../../public/images/logoBey.png";
...
const Navbar = () => {
    ...
    return (
        <div className="w-full text-white flex items-center justify-between z-10 h-[70px] bg-blue-400 px-10">
            <Link href="/">
                <Image
                    src={
                        logo
            ...
            >
                ...
                {!isLoggedIn ? (
                    ...
                    <button onClick={() => {setIsProfileDropdownOpen(!isProfileDropdownOpen)}}>
                        {isProfileDropdownOpen && <NavbarDropdown photo={userData.photo} name={userData.firstName} surname={userData.lastName} /> }
                        {userData.photo ? (
                            <Image
                                className="-mt-1"
                                src={userData.photo}
