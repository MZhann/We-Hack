...
const SignIn = () => {
    ...
    return (
        <div className="w-full flex flex-col items-center bg-white min-h-screen ">
            <div className="absolute text-white font-bold flex justify-center items-center text-center text-2xl mt-5 z-50">
                Log In
            </div>
            <div className="w-full h-[70px] bg-blue-400 z-40 ">
                <Link href='/' className="z-40">
                    <h1 className="text-2xl text-white hover:text-3xl hover:pb-2 mt-5 ml-4">Back</h1>
                </Link>
            </div>
            <input
                id="email"
